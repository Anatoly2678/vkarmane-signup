...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signupForm = __webpack_require__(1);

	var _signupForm2 = _interopRequireDefault(_signupForm);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	ReactDOM.render(React.createElement(_signupForm2.default, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fullnameInput = __webpack_require__(48);

	var _fullnameInput2 = _interopRequireDefault(_fullnameInput);

	var _birthdayInput = __webpack_require__(49);

	var _birthdayInput2 = _interopRequireDefault(_birthdayInput);

	var _emailInput = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMaskedinput = __webpack_require__(3);

	var _reactMaskedinput2 = _interopRequireDefault(_reactMaskedinput);

	var _phoneVerificationBox = __webpack_require__(47);
	...
	exports.default = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var phoneVerificationBox = React.createElement(_phoneVerificationBox2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputMask = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMSelection = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNodeForCharacterOffset = __webpack_require__(39);
	...
	exports.default = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            this.state.codeInputVisible ? React.createElement(
	                "div",
	                null,
	                React.createElement(
	                    "div",
	                    { className: "form-group" },
	                    React.createElement("input", { value: this.state.code, className: "form-control",
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'label',
	                    null,
	                    React.createElement('input', { type: 'checkbox', checked: this.state.noMiddleName, onChange: this.handleNoMiddleNameChange }),
	                    'без отчества'
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rangeRight = __webpack_require__(65);
	...
	exports.default = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var days = (0, _map2.default)((0, _range2.default)(1, 32), function (n) {
	            return React.createElement(
	                'option',
	                { value: n, key: n },
	                n
	        ...
	        var years = (0, _map2.default)((0, _rangeRight2.default)(1950, 1996), function (n) {
	            return React.createElement(
	                'option',
	                { value: n, key: n },
	                n
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'form-group ' + $if(this.state.dateNotValid, 'has-error') },
	                React.createElement(
	                    'div',
	                    { className: 'row' },
	                    React.createElement(
	                ...
	                $if(this.state.dateNotValid, React.createElement(
	                    'span',
	                    { className: 'help-block' },
	                    'Пожалуйста, заполните поле корректно'
	                ))
	    ...
	    handleDayChange: function handleDayChange(e) {
	        ...
	        (0, _defer2.default)(this.validateDate);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createRange = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseRange = __webpack_require__(52),
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var checkGlobal = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(122),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(123);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDelay = __webpack_require__(165),
	    rest = __webpack_require__(166);
	...
	exports.default = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'form-group ' + $if(this.state.emailEmpty || this.state.emailExists, 'has-error') },
	                React.createElement('input', { type: 'email', className: 'form-control', id: 'emailInput',
	                    value: this.state.email, placeholder: 'address@example.com', onChange: this.handleEmailChange }),
	                $if(this.state.emailEmpty, React.createElement(
	                    'span',
	                    { className: 'help-block' },
	                    'Пожалуйста, заполните поле'
	                )),
	                $if(this.state.emailExists, React.createElement(
	                    'span',
	                    { className: 'help-block' },
	                    'Этот email уже зарегистрирован'
	                )),
	                $if(this.state.emailBlocked, React.createElement(
	                    'span',
	                    { className: 'help-block' },
