...
/***/ function(module, exports, __webpack_require__) {
	...
	var _recovery = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactHelpers = __webpack_require__(64);
	...
	var PhoneInput = function PhoneInput(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        (0, _reactHelpers.$if)(phone.readyToCheck && !phone.sent, _react2.default.createElement(
	            'button',
	...
	var VerificationBlock = function VerificationBlock() {
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	        ...
	        (0, _reactHelpers.$if)(true, _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	                'div',
	                { className: 'form-group' },
	                _react2.default.createElement('input', { className: 'form-control', placeholder: 'Код из СМС' })
	            ),
	            _react2.default.createElement(
	                'button',
	                {
	...
	var RecoveryForm = function RecoveryForm(_ref2) {
	    ...
	    return _react2.default.createElement(
	        ...
	        (0, _reactHelpers.$if)(phone.message || verification.message, _react2.default.createElement(
	            'div',
	        ...
	        (0, _reactHelpers.$if)(verification.sendingCode, _react2.default.createElement(
	            'div',
	            { className: 'progress' },
	            _react2.default.createElement('div', { className: 'progress-bar progress-bar-striped active', style: { width: '100%' } })
	        )),
	        (0, _reactHelpers.$if)(verification.codeId, _react2.default.createElement(VerificationBlock, null))
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.sendCode = exports.changePassword = exports.receiveCodeId = exports.failSendCode = exports.requestCode = exports.changePhoneNumber = undefined;
	...
	var failSendCode = exports.failSendCode = (0, _reduxActions.createAction)('FAIL_SEND_CODE');
	var receiveCodeId = exports.receiveCodeId = (0, _reduxActions.createAction)('RECEIVE_CODE_ID');
	var changePassword = exports.changePassword = (0, _reduxActions.createAction)('CHANGE_PASSWORD');
	...
	var sendCode = exports.sendCode = function sendCode(number) {
	    return function (dispatch) {
	        ...
	        return post('/Recovery.aspx/SendCodeForPasswordChange', {
	            ...
	            return dispatch(failSendCode(ex.message || ex.Message || ex.toString()));
	        });
	    };
	};
	...
	}), _defineProperty(_handleActions, requestCode, function (state) {
	    return _extends({}, state, {
	        sent: true
	    });
	}), _handleActions), {
	...
	var verification = (0, _reduxActions.handleActions)((_handleActions2 = {}, _defineProperty(_handleActions2, requestCode, function (state) {
	    return _extends({}, state, {
	        sendingCode: true,
	        codeId: '',
	        code: '',
	...
	}), _defineProperty(_handleActions2, receiveCodeId, function (state, action) {
	    return _extends({}, state, {
	        sendingCode: false,
	        verified: true,
	        codeId: action.payload
	    });
	}), _defineProperty(_handleActions2, failSendCode, function (state, action) {
	    return _extends({}, state, {
	        sendingCode: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handleActions = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ownKeys = __webpack_require__(70);

	var _ownKeys2 = _interopRequireDefault(_ownKeys);

	var _reduceReducers = __webpack_require__(71);
