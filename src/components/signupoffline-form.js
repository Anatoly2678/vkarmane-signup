...
//        console.log (cookie.get('point'));
    ...
    render() {
        ...
        return (
            <form className="form-signin" onSubmit={e => {
                ...
                <h3 className="form-signin-heading">Регистрация (Offline)</h3>
    ...
    handleContinueClick(e) {
        ...
        const token = {
            ...
            Point: cookie.get('point')} /* Наследие предков */

        this.setState({ waitingForSignup: true })
        $.ajax({
            type: "POST",
            url: '/Register.aspx/RegisterOffline',
